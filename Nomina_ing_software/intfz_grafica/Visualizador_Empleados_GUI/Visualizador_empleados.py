...
class VisualizadorEmpleados:
    ...
    def create_header(self):
        ...
        # Título
        canvas.create_text(400, 30, text="Visualización de Empleados", 
    ...
    def create_main_panel(self):
        ...
        tab_control.add(self.tab_listado, text="Listado de Empleados")
    ...
    def create_listado_tab(self):
        ...
        self.tree["columns"] = ("Nombre", "Apellido", "Cédula", "Estado")
        
        # Configurar columnas
        self.tree.column("#0", width=60, stretch=tk.NO)
        self.tree.column("Nombre", width=180, anchor=tk.W)
        self.tree.column("Apellido", width=180, anchor=tk.W)
        self.tree.column("Cédula", width=150, anchor=tk.CENTER)
    ...
    def cargar_empleados(self):
        ...
        try:
            ...
            rutas = [
                'Nomina_ing_software/archivos_de_texto/Empleados.txt',
                'Empleados.txt'
            ]
            ...
            if not ruta_encontrada:
                messagebox.showerror("Error", "No se encontró el archivo Empleados.txt")
                return
            ...
            for linea in lineas:
                ...
                if len(datos) >= 3:
                    ...
                    self.tree.insert("", tk.END, text=f"{contador}", 
                                    values=(nombre, apellido, cedula, estado), tags=(tag,))
                else:
            ...
            if contador == 1:
                self.tree.insert("", tk.END, text="", 
                               values=("No hay empleados registrados", "", ""))
    ...
    def buscar_empleado(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Error al buscar empleados: {str(e)}")
    ...
    def mostrar_ayuda(self):
        ...
        contenido = tk.Label(help_window, text=
                           "Este sistema permite visualizar el listado de empleados.\n\n"
